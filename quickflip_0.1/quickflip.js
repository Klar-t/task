...
var quickFlip = {
    ...
    newPanel : [],
    oldPanel : [],
    speed    : [ 10000, 10000 ], // close speed , open speed
    ...
    flip : function( i, j, repeater) {
        ...
        $panel1.stop(true,true).animate( { width : 0 }, speed[0], function() {
            if ( ! count1 ) count1++;
            else {
                $panel1.remove();
                ...
                $panel2.stop(true,true).animate( { width : x.halfwidth }, speed[1], function() {
                    if ( !count2 ) count2++;
                    else {
                        $panel2.remove();
                        x.panels[k].show();
                        ...
                        switch( repeater ) {
                            ...
                            case 1: //stop if is last flip, and attach events for msie
                                ...
                                //
                                //     else{quickFlip.attachHandlers($('.quickFlipCta', x.panels[k]), i, k)};
                                // }
